<?php
  session_start();
  define("KBSERVICE","CodingStudentProject");
  define("UID","feG4nYZlvt48DAQ2dgX0eZXtYyWEDtH3QvYtuYit2OY");
  define("EMAIL","vicksemmanuel58@gmail.com");
  define("USER","Mary magdalene");
  define("AMOUNT","&#8358;15,000");
  define("AMOUNTY","15000");
  define("PHOTOURL","../../image/john-paul-henry-307807-unsplash.jpg");
  define("PHONE_NUM","+2348074434878");
  $percent="100%";
  if($percent=="30%"){
    define("PERCENTPAY","30%");
  }else{
    define("PERCENTPAY","100%");
  }
  ...
  $_SESSION["amounty"]=AMOUNTY;
  $_SESSION["percent"]=$percent;
  $_SESSION["service"]=KBSERVICE;
  $_SESSION["email"]=EMAIL;
  session_regenerate_id();
?>
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <title>Kode Bottle : Coding Student Project</title>
  ...
  <script>
    $(document).ready(function(){
      ...
      $("#home").click(function(event){
        ...
        window.location.href="/kodebottle/";
      });
      $("#about").click(function(event){
        event.preventDefault();
        window.location.href="/kodebottle/#about";
      });
      $("#contact").click(function(event){
        event.preventDefault();
        window.location.href="/kodebottle/#contact";
      });
    });
  </script>
</head>
<body>
      <div id="menu">
        ...
        <li class="den-link-cancel">x</li>
          ...
          <a class="class dodgerblue" href="/kodebottle/codingstudentproject/"><svg version="1.1" id="roar" class="dodgerblue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 47.94 47.94" style="transition: 0.4s;" xml:space="preserve">
          ...
          <a class="class yellowey" href="/kodebottle/branding/"><svg version="1.1" id="roar" class="yellowey" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;" xml:space="preserve">
                                              <g>
          ...
          <a class="class white" href="/kodebottle/webapps/"><svg version="1.1" id="roar" class="white" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="522.468px" height="522.469px" viewBox="0 0 522.468 522.469" style="enable-background:new 0 0 522.468 522.469;" xml:space="preserve">
                                              <g>
                                              <g>
          ...
          <a class="class shell" href="/kodebottle/apps/">
      ...
      <div class="width">
          <div class="floating-div">
              <img src="<?php echo PHOTOURL;?>" class="youandyourself"/>
              <div class="thyself"><?php echo USER;?></div>
          </div>
          <div class="kodebottler">
              <img src="../../image/cropped-kodebottle-logo-full-png-3.png" class="hmm"/>
          </div>
          <div class="payer">
              <div class="pushaway">
                <span class="whattopay"><?php echo AMOUNT;?></span>
                <div class="door">
                    <div class="champ">
                        <svg version="1.1" id="blast" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            ...
                            <g>
                                ...
                                <path d="M314.494,359.32c-1.484-3.6-3.172-7.678-4.896-12.299c-12.924-34.649-5.34-56.393,1.352-75.569
                                    ...
                                    C322.274,378.158,319.01,370.256,314.494,359.32z"/>
                                <rect x="165.963" y="140.058" stroke="#000000" stroke-miterlimit="10" width="151.856" height="103.676"/>
                                <polyline fill="#FFFFFF" points="185.477,140.059 209.477,322.059 236.477,313.059 202.477,343.059 	"/>
                                <g>
                                    <path fill="#FFFFFF" d="M208.066,188.277h3.963v14.803h0.137c0.82-1.184,1.64-2.277,2.414-3.279l9.382-11.524h4.919
                                        l-11.113,13.027l11.979,17.672h-4.691L214.944,203.9l-2.915,3.371v11.706h-3.963V188.277z"/>
                                    <path fill="#FFFFFF" d="M252.568,207.772c0,8.153-5.648,11.706-10.978,11.706c-5.966,0-10.566-4.373-10.566-11.341
                                        c0-7.378,4.828-11.706,10.932-11.706C248.286,196.431,252.568,201.031,252.568,207.772z M235.077,208
                                        c0,4.828,2.778,8.472,6.695,8.472c3.826,0,6.695-3.599,6.695-8.563c0-3.735-1.867-8.472-6.604-8.472
                                        C237.127,199.437,235.077,203.809,235.077,208z"/>
                                    <path fill="#FFFFFF" d="M276.664,186.638v26.646c0,1.958,0.045,4.19,0.182,5.693h-3.598l-0.183-3.826h-0.091
                                        c-1.23,2.46-3.917,4.327-7.516,4.327c-5.329,0-9.429-4.509-9.429-11.205c-0.045-7.333,4.51-11.842,9.884-11.842
                                        c3.371,0,5.648,1.594,6.65,3.371h0.091v-13.164H276.664z M272.656,205.904c0-0.501-0.045-1.184-0.182-1.685
                                        c-0.593-2.551-2.778-4.646-5.785-4.646c-4.145,0-6.604,3.644-6.604,8.518c0,4.463,2.187,8.153,6.514,8.153
                                        c2.688,0,5.146-1.776,5.876-4.782c0.137-0.547,0.182-1.093,0.182-1.731V205.904z"/>
                                    <path fill="#FFFFFF" d="M285.546,208.683c0.091,5.42,3.553,7.652,7.562,7.652c2.869,0,4.6-0.501,6.103-1.139l0.684,2.869
                                        c-1.412,0.638-3.826,1.366-7.333,1.366c-6.787,0-10.841-4.463-10.841-11.113s3.917-11.888,10.34-11.888
                                        c7.196,0,9.109,6.331,9.109,10.385c0,0.82-0.091,1.458-0.137,1.867H285.546z M297.297,205.813
                                        c0.046-2.551-1.047-6.514-5.557-6.514c-4.054,0-5.83,3.735-6.148,6.514H297.297z"/>
                                </g>
                        ...
                        <span class="whattosay"><?php echo PERCENTPAY;?> Pay</div>
                    </div>
                </div>
              </div>
          </div>
                ...
                <div class="weepit">
                  <ul class="orange">
                    <li class="forward">
                      ...
                      <ul class="ye">
                        <li class="soup"><a class="tv" href="/kodebottle/">Home</a></li>
                        <li class="soup"><a class="tv soo" href="/kodebottle/#about">About</a></li>
                        <li class="soup"><a class="tv soo" href="/kodebottle/#contact">Contact</a></li>
                        <li class="soup"><a class="tv soo" href="/kodebottle/#services">Services</a></li>
                        <li class="soup"><a class="tv" href="/kodebottle/blog/">Blog</a></li>
                        <li class="soup"><a class="tv" href="/kodebottle/">Our Policies</a></li>
                      </ul>
                    </li>
                    <li class="forward">
                      <h6 class="qubit">Services</h6>
                      <ul class="ye">
                        <li class="soup"><a class="tv" href="/kodebottle/codingstudentproject/">Coding Student Project</a></li>
                        <li class="soup"><a class="tv" href="/kodebottle/branding/">Branding</a></li>
                        <li class="soup"><a class="tv" href="/kodebottle/apps/">Software/ Apps</a></li>
                        <li class="soup"><a class="tv" href="/kodebottle/webapps/">Web Apps</a></li>
                      </ul>
                    </li>
                    <li class="forward">
      ...
      <script>
         $(".door").click(function(){
          $(".door").css({"transition":".4s","background-color":"slateblue","color":"rgb(17,15,38)"});
          setTimeout(() => {
            <?php
              echo "payWithPaystack('pk_test_dacad1f67d77956982197b1e01dc4fb80e77166a','".EMAIL."','".AMOUNTY."','".PHONE_NUM."');"  ;
            ?>
            $(".door").css({"transition":".4s","color":"slateblue","background-color":"rgb(17,15,38)"});
          }, 200);

          function payWithPaystack(key,email,amount,phone_num) {
            var handler = PaystackPop.setup({ 
                    ...
                    custom_fields: [
                        {
                            ...
                            value: phone_num //customer's mobile number
                        }
                    ]
                },
                callback: function (response) {
                    ...
                    $.post("../config.php", {reference:response.reference}, function(status){
                        if(status == "success")
